...
#include "meltan/core/examples/simple_failure/params.pb.h"
#include "meltan/core/examples/simple_failure/simple_lib.h"
...
int main(int argc, char* argv[]) {
  ...
  meltan::simple_failure::Params params;
