...
#ifndef MELTAN_LIB_TESTING_FAKE_TEST_RUN_H_
#define MELTAN_LIB_TESTING_FAKE_TEST_RUN_H_
...
class FakeTestRun : public meltan::results::TestRun {
 public:
  FakeTestRun(std::string name, results::internal::ArtifactWriter&& aw) :
    meltan::results::TestRun(name, std::move(aw)) {}
...
#endif  // MELTAN_LIB_TESTING_FAKE_TEST_RUN_H_
