...
#ifndef MELTAN_LIB_TESTING_MOCK_RESULTS_H_
#define MELTAN_LIB_TESTING_MOCK_RESULTS_H_
...
class MockTestRun : public TestRun {
 public:
  ...
  MOCK_METHOD(meltan::results_pb::TestResult, End, (), (override));

  MOCK_METHOD(meltan::results_pb::TestResult, Skip, (),
              (override));
  ...
  MOCK_METHOD(meltan::results_pb::TestStatus, Status, (),
              (override, const));

  MOCK_METHOD(meltan::results_pb::TestResult, Result, (),
              (override, const));
...
class MockTestStep : public TestStep {
 public:
  ...
  MOCK_METHOD(void, AddDiagnosis,
              (meltan::results_pb::Diagnosis::Type, std::string,
  ...
  MOCK_METHOD(void, AddFile, (meltan::results_pb::File),
              (override));
  ...
  void DelegateToReal() {
    ...
    ON_CALL(*this, AddMeasurement(_, _, _))
        .WillByDefault(
            [&](meltan::results_pb::MeasurementInfo i,
                meltan::results_pb::MeasurementElement elem,
                const meltan::results::HwRecord* r) {
    ...
    ON_CALL(*this, AddElementWithRange(_, _))
        .WillByDefault(
            [&](google::protobuf::Value val,
                meltan::results_pb::MeasurementElement::Range r) {
...
#endif  // MELTAN_LIB_TESTING_MOCK_RESULTS_H_
