...
#include "meltan/lib/results/internal/utils.h"
#include "meltan/lib/results/results.pb.h"

ABSL_DECLARE_FLAG(bool, meltan_copy_results_to_stdout);
ABSL_DECLARE_FLAG(std::string, meltan_results_filepath);
ABSL_DECLARE_FLAG(std::string, machine_under_test);
ABSL_DECLARE_FLAG(bool, meltan_strict_reporting);
...
// 'meltan/lib/testing/mock_results.h'
class ResultApi {
 public:
  ResultApi() = default;
  ...
  BeginMeasurementSeries(TestStep* parent, const HwRecord& hw,
                         meltan::results_pb::MeasurementInfo info);
#endif
};
...
class TestRun : public internal::LoggerInterface {
 public:
  ...
  virtual meltan::results_pb::TestResult End();

  // Skips and ends the Test.
  // Should be part of, or followed by a return statement.
  virtual meltan::results_pb::TestResult Skip();
  ...
  virtual meltan::results_pb::TestStatus Status() const;

  // Returns the current overall TestRun result
  virtual meltan::results_pb::TestResult Result() const;
 ...
 private:
  ...
  //
  friend class meltan::FakeTestRun;
#ifndef SWIG
  ...
  void WriteLog(meltan::results_pb::Log::Severity,
  ...
  meltan::results_pb::TestResult result_ ABSL_GUARDED_BY(mutex_);
  meltan::results_pb::TestStatus status_ ABSL_GUARDED_BY(mutex_);
};
...
class TestStep : public internal::LoggerInterface {
 public:
  ...
  virtual void AddDiagnosis(meltan::results_pb::Diagnosis::Type,
  ...
  virtual void AddMeasurement(
      meltan::results_pb::MeasurementInfo,
      meltan::results_pb::MeasurementElement,
      const HwRecord* hwrec);

  // Emits a File artifact
  virtual void AddFile(meltan::results_pb::File);
  ...
  meltan::results_pb::TestStatus Status() const;
  ...
  absl::Status ValidateMeasElem(
      const meltan::results_pb::MeasurementElement&);
...
class DutInfo {
 public:
  ...
  HwRecord AddHardware(meltan::results_pb::HardwareInfo);
  ...
  // must be registered with the TestRun object before the record can be used.
  SwRecord AddSoftware(meltan::results_pb::SoftwareInfo);
  ...
  const meltan::results_pb::DutInfo& ToProto() const {
    return proto_;
  }

 private:
  meltan::results_pb::DutInfo proto_;
  bool registered_;
...
class HwRecord {
 public:
  ...
  const meltan::results_pb::HardwareInfo& Data() const {
    return data_;
  }
 ...
 private:
  ...
  friend DutInfo;
  explicit HwRecord(meltan::results_pb::HardwareInfo i)
      : data_(std::move(i)) {}
  meltan::results_pb::HardwareInfo data_;
};
...
class SwRecord {
 public:
  ...
  const meltan::results_pb::SoftwareInfo& Data() const {
    return data_;
  }
 ...
 private:
  ...
  friend DutInfo;
  explicit SwRecord(meltan::results_pb::SoftwareInfo i)
      : data_(std::move(i)) {}
  meltan::results_pb::SoftwareInfo data_;
};
...
class MeasurementSeries {
 public:
  ...
  virtual void AddElement(
      ...
      meltan::results_pb::MeasurementElement::Range range) {
  ...
  virtual void AddElementWithRange(
      ...
      meltan::results_pb::MeasurementElement::Range);
 ...
 private:
  ...
  meltan::results_pb::MeasurementInfo info_;
};
