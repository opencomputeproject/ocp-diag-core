...
TEST(TestStepValueCompareTest, Numbers) {
  ...
  // Test really large numbers, to ensure this works with large differences.
  EXPECT_LT(TestStep::Compare(
                ParseTextProtoOrDie(R"pb(number_value: 0)pb"),
                ParseTextProtoOrDie(R"pb(number_value: 17643725702534)pb")),
            0);
  EXPECT_GT(TestStep::Compare(ParseTextProtoOrDie(R"pb(number_value:
                                                           17643725702534)pb"),
                              ParseTextProtoOrDie(R"pb(number_value: 0)pb")),
            0);
}
