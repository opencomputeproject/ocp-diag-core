...
class TestRunTest(ResultsTestBase):
  ...
  def testTestRunLogs(self):
    ...
    self.assertEqual(self.output.model.logs.debug[0].text, "A")
    self.assertEqual(self.output.model.logs.info[0].text, "B")
    self.assertEqual(self.output.model.logs.warning[0].text, "C")
    self.assertEqual(self.output.model.logs.error[0].text, "D")
    self.assertEqual(self.output.model.logs.fatal[0].text, "E")
...
class TestRunStep(ResultsTestBase):
  ...
  def testTestStepBegin(self):
    ...
    self.assertIn("0", self.output.model.test_steps.keys())
    self.assertEqual(self.output.model.test_steps["0"].start.name,
                     "TestStepTest")
  ...
  def testTestStepAddDiagnosis(self):
    ...
    self.assertEqual(self.output.model.test_steps["0"].diagnoses[0].type,
  ...
  def testTestStepAddError(self):
    ...
    errors = self.output.model.test_steps["0"].errors
  ...
  def testTestStepAddMeasurement(self):
    ...
    measurements = self.output.model.test_steps["0"].measurements
  ...
  def testTestStepAddFile(self):
    ...
    files = self.output.model.test_steps["0"].files
  ...
  def testTestStepAddArtifactExtension(self):
    ...
    extensions = self.output.model.test_steps["0"].artifact_extensions
  ...
  def testTestStepDebug(self):
    ...
    logs = self.output.model.test_steps["0"].logs
...
class TestMeasurementSeries(ResultsTestBase):
  ...
  def testMeasurementSeriesBegin(self):
    ...
    measurement_series = self.output.model.test_steps["0"].measurement_series
